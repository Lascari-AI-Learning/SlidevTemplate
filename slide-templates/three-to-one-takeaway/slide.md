...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 my-6">
    <div v-if="$clicks >= 1" class="bg-white border-{{idea1_color}}-600 border-1 rounded-lg p-4 text-sm text-center flex items-center justify-center">
      <p>
    ...
    <div v-if="$clicks >= 2" class="bg-white border-{{idea2_color}}-600 border-1 rounded-lg p-4 text-sm text-center flex items-center justify-center">
      <p>
    ...
    <div v-if="$clicks >= 3" class="bg-white border-{{idea3_color}}-600 border-1 rounded-lg p-4 text-sm text-center flex items-center justify-center">
      <p>
